            ...
            require_once "connect.php";
             ...
             if ($conn->connect_errno!=0) { echo "Error: ".$conn->connect_errno;}
                ...
                if($rezultat = @$conn->query($sql)){
                    ...
                    if($ilosc_wierszy==0){
                        echo "Brak wyników w danej kategorii";
                    }else{
                        for($i=0; $i<$ilosc_wierszy; $i++){
                           ...
                           // echo $wiersz['product_id'].''.$wiersz['name'];
                            ...
                            echo ' <div class="col-12 col-md-8 ">
                                        ...
                                        <b>Ilość: '.$wiersz['quantity'].'<br>
                                        Cena za sztukę: '.$wiersz['price'].'zł</b><br><br>
                                        Numer identyfikujący sprzedawcę:'.$wiersz['user_id'].'<br><br>
