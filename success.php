...
<body>
    ...
    <div class="container-fluid text-center main">
        <div class="categories basket  mx-md-12">
            <h1 class="">Pomyślnie się zarejestrowałeś</h1>


            <div class="row">
                <div class="col-12">
                    <h2 class="p-2">Witaj nowy użytkowniku!</h2>
                    Twoja rejestracja przebiegła w pełni pomyślnie, teraz możesz zalogować się na swoje konto i w pełni korzystać z naszego portalu.
                    <br/>Życzymy udanych zakupów!
                </div>
